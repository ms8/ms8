...
/**
 * This is the model class for table "prepare_detail".
 *
 * The followings are the available columns in table 'prepare_detail':
 ...
 */
class PrepareDetail extends CActiveRecord
{
	/**
	 ...
	 * @return PrepareDetail the static model class
	 */

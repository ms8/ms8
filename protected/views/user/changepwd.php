    ...
    <div class="con clear">
            ...
            <div class="left2c">
                <div class="left2c1"><?php echo $form->labelEx($model,'旧密码'); ?>:</div>
                <div class="left2c21 bgcl2">
                    <?php echo $form->passwordField($model,'oldpass',array('class'=>'inp6','value'=>'')); ?>
                </div>
            </div>
            <div class="left2c">
                <div class="left2c1"><?php echo $form->labelEx($model,'新密码'); ?>:</div>
                <div class="left2c21 bgcl2">
                    <?php echo $form->passwordField($model,'password',array('class'=>'inp6')); ?>
                </div>
            </div>
            <div class="left2c">
                <div class="left2c1"><?php echo $form->labelEx($model,'确认密码'); ?>:</div>
                <div class="left2c21 bgcl2">
                    <?php echo $form->passwordField($model,'password',array('class'=>'inp6')); ?>
                </div>
            </div>
